      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    ?>
                        ...
                        <td> <a href="atualizarUser.php?user_id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm"> Atualizar</a>
              ...
              <a href="imprimirrelatorio_users.php" name ='pdfg' value='pdfg'class="btn btn-primary" > PDF </a>
     </div>
   </div>
    </div>
      </div>
