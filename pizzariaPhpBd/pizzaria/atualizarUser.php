        ...
        <div class="col-md-12">
           ...
           <div class="card">
              <div class="card-header">
                ...
                <a href="registarUser.php"  class="btn btn-danger btn-sm float-right">Voltar</a>
              </div>
          <!-- /.card-header -->
...
<div class="card-body">
    <div class="row">
        ...
        <div class="form-group">
          <label>Morada</label>
          <input type="text" name="morada" value="<?php echo $row['morada'] ?>" class="form-control" placeholder="Nome">   
        </div>
        <div class="form-group">
          <label>NIF</label>
          <input type="text" name="nif" value="<?php echo $row['nif'] ?>" class="form-control" placeholder="Nome">   
        </div>
        <div class="form-group">
          <label>Email</label>
